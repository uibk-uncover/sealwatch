...
class PharmOriginalFeatureExtractor(object):
    ...
    def _all_2x2(self, img, seed):
        ...
        Dh = (  img[I.start - 1:I.stop - 1, J.start - 1:J.stop - 1] # left top
        ...
        #  [-1,  1]]
        # X(I-1,J-1) - X(I-1,J) + X(I,J-1) - X(I,J)
        Dv = (  img[I.start - 1:I.stop - 1, J.start - 1:J.stop - 1] # left top
              - img[I.start - 1:I.stop - 1, J] # right top
              + img[I, J.start - 1:J.stop - 1] # left bottom
              - img[I, J]) # right bottom
        ...
        #  [-1,  1]]
        # -X(I-1,J-1)+X(I-1,J)+X(I,J-1)-X(I,J)
        Dd = (  - img[I.start - 1:I.stop - 1, J.start - 1:J.stop - 1] # left top
