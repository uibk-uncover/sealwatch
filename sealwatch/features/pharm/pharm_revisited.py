...
class PharmRevisitedFeatureExtractor(object):
    def __init__(
        ...
        This implementation intentionally deviates from the original Matlab implementation.
...
def extract_pharm_revisited_features(
    img_filepath,
    quantization_step=5,
    num_projections=100,
    T=2,
    ...
    Intentionally deviates from the original implementation.
